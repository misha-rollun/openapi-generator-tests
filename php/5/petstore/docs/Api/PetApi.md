...
------------- | ------------- | ------------- | -------------
 **pet** | [**\OpenAPI\Client\Model\Pet**](../Model/Pet.md)| Create a new pet in the store |
...
$pet = new \OpenAPI\Client\Model\Pet(); // \OpenAPI\Client\Model\Pet | Update an existent pet in the store
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pet** | [**\OpenAPI\Client\Model\Pet**](../Model/Pet.md)| Update an existent pet in the store |
...
```php
uploadFile($pet_id, $additional_metadata, $body): \OpenAPI\Client\Model\ApiResponse
```
