...
------------- | ------------- | ------------- | -------------
 **user** | [**\OpenAPI\Client\Model\User**](../Model/User.md)| Created user object | [optional]
...
```php
createUsersWithListInput($user): \OpenAPI\Client\Model\User
```
...
$user = array(new \OpenAPI\Client\Model\User()); // \OpenAPI\Client\Model\User[]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user** | [**\OpenAPI\Client\Model\User[]**](../Model/User.md)|  | [optional]
...
$user = new \OpenAPI\Client\Model\User(); // \OpenAPI\Client\Model\User | Update an existent user in the store
 ...
 **user** | [**\OpenAPI\Client\Model\User**](../Model/User.md)| Update an existent user in the store | [optional]
