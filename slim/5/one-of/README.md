# php-base - PHP Slim 4 Server library for OneOf
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **shopsGet** | **GET** /shops | 


## Models

* OpenAPIServer\Model\BookShopInfo
* OpenAPIServer\Model\Shop
* OpenAPIServer\Model\ShopInfo
* OpenAPIServer\Model\ShopListResult
* OpenAPIServer\Model\SupermarketInfo
