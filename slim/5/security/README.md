# php-base - PHP Slim 4 Server library for Security
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **basicGet** | **GET** /basic | 
*AbstractDefaultApi* | **bearerGet** | **GET** /bearer | 
*AbstractDefaultApi* | **multipleGet** | **GET** /multiple | 
*AbstractDefaultApi* | **oauth2Get** | **GET** /oauth2 | 


## Models

* OpenAPIServer\Model\Resource
* OpenAPIServer\Model\ResourceListResult
