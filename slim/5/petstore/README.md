# php-base - PHP Slim 4 Server library for Swagger Petstore - OpenAPI 3.0
...
*AbstractUserApi* | **updateUser** | **PUT** /user/{username} | Update user
